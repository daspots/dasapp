(function webpackUniversalModuleDefinition(root, factory) {
    ...
    function createContainer(w, h, el, altText, opts) {
        ...
        con.setAttribute("style", "position:relative;cursor:pointer;background:none;border:none;padding:0;margin:5px;");
    ...
    function process(el, gifs, options) {
        ...
        var url, con, c, w, h, duration, play, gif, playing = false,
            cc, isC, durationTimeout, dims, altText, stopped_by_click = false;
        ...
        el.onload = function() {
            ...
            con.appendChild(c);
            con.setAttribute("style", "position:relative;cursor:pointer;width:" + dims.w + "px;height:" + dims.h + "px;background:none;border:none;padding:0;margin:5px;");
            c.style.width = "100%";
            c.style.height = "100%";
