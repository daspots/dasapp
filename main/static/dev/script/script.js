...
$('.box').click(function(){
  if(opened == false){
    $('.tab-content').animate({height: "200px"});
    opened = true;
  }else{
    $('.tab-content').animate({height: "0px"}).animate({height: "200px"});
    opened = false;
  }
})
